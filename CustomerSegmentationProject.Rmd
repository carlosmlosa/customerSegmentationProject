---
title: "Project"
author: "Albert Mandizha(A20493341), Yuanyuan Sun(A20487775), Chao Yang(A20511318), Carlos Muñoz Losa(A20521562), Talvinder Kour(A20489751)"
output:
...
```{r}
# setwd("C:/Users/user/Documents/rcodes/albert/CSP571-main (1)/CSP571-main")


age18_25 = Mall_Customers1$Age[(Mall_Customers1$Age <= 25) & (Mall_Customers1$Age>= 18)]
age26_35 = Mall_Customers1$Age[(Mall_Customers1$Age <= 35) & (Mall_Customers1$Age>= 26)]
age36_45 = Mall_Customers1$Age[(Mall_Customers1$Age <= 45) & (Mall_Customers1$Age>= 36)]
age46_55 = Mall_Customers1$Age[(Mall_Customers1$Age <= 55) & (Mall_Customers1$Age>= 46)]
age55above =Mall_Customers1$Age[Mall_Customers1$Age >= 56]

dfC=structure(list(Number_Of_Customers=c(length(age18_25),length(age26_35),length(age36_45),length(age46_55),length(age55above)),
                   age=c("18-25","26-35","36-45","46-55","55+")),row.names = c(NA, 6L), class = "data.frame")
dfC=dfC[-6,]
library(ggplot2)
p<-ggplot(data=dfC, aes(x=age, y=Number_Of_Customers ), palette.colors(palette = "Blue") ) +
...
```{r}
library(ggplot2)
ss1_20 = Mall_Customers1["Spending.Score"][(Mall_Customers1["Spending.Score"] >= 1) & (Mall_Customers1["Spending.Score"] <= 20)]
ss21_40 = Mall_Customers1["Spending.Score"][(Mall_Customers1["Spending.Score"] >= 21) & (Mall_Customers1["Spending.Score"] <= 40)]
ss41_60 = Mall_Customers1["Spending.Score"][(Mall_Customers1["Spending.Score"] >= 41) & (Mall_Customers1["Spending.Score"] <= 60)]
ss61_80 = Mall_Customers1["Spending.Score"][(Mall_Customers1["Spending.Score"] >= 61) & (Mall_Customers1["Spending.Score"] <= 80)]
ss81_100 = Mall_Customers1["Spending.Score"][(Mall_Customers1["Spending.Score"] >= 81) & (Mall_Customers1["Spending.Score"] <= 100)]

sns=structure(list(Score = c("1-20", "21-40", "41-60", "61-80", "81-100"),
                   N_Of_Customers_Having_Score = c(length(ss1_20), length(ss21_40), length(ss41_60), length(ss61_80), length(ss81_100)),
                   class = "data.frame")
                   )
sns1=data.frame(sns)
s<-ggplot(data=sns1, aes(x=Score , y=N_Of_Customers_Having_Score ), palette.colors(palette = "Blue") ) +
  geom_bar(stat="identity")
s
```

#Understanding the Income Level

```{r}
library(ggplot2)
ai0_30 = Mall_Customers1["Annual.Income"][(Mall_Customers1["Annual.Income"] >= 0) & (Mall_Customers1["Annual.Income"] <= 30)]
ai31_60 = Mall_Customers1["Annual.Income"][(Mall_Customers1["Annual.Income"] >= 31) & (Mall_Customers1["Annual.Income"] <= 60)]
ai61_90 = Mall_Customers1["Annual.Income"][(Mall_Customers1["Annual.Income"] >= 61) & (Mall_Customers1["Annual.Income"] <= 90)]
ai91_120 = Mall_Customers1["Annual.Income"][(Mall_Customers1["Annual.Income"] >= 91) & (Mall_Customers1["Annual.Income"] <= 120)]
ai121_150 = Mall_Customers1["Annual.Income"][(Mall_Customers1["Annual.Income"] >= 121) & (Mall_Customers1["Annual.Income"] <= 150)]

ai=structure(list(income = c("0-30", "31-60", "61-90", "91-120", "121-150"),
                  N_Of_Customers = c(length(ai0_30), length(ai31_60), length(ai61_90), length(ai91_120), length(ai121_150)),
                  class = "data.frame"))
ai1=data.frame(ai)
ann<-ggplot(data=ai1, aes(x=income, y=N_Of_Customers), palette.colors(palette = "Blue") ) +
  geom_bar(stat="identity")
ann
```
